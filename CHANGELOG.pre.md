...
CONTENT RULES (never change)
  ...
  • Links point only at IMMUTABLE targets — a PR, commit, or issue:
    ([#N](https://github.com/whuppi/fluent_bundle/issues/N) reported by
    [@user](https://github.com/user), [PR #N](https://github.com/whuppi/fluent_bundle/pull/N)).
...
First release — Project Fluent for Dart: spec-complete parser and resolver, inline-markup spans, locale negotiation and bundle chains, pluggable CLDR backends.
