#!/bin/bash
# ============================================================================
# fluent_bundle secrets manager
#
# Manages secrets for whuppi/fluent_bundle ONLY.
...
REPO="whuppi/fluent_bundle"
BWS="${HOME}/bin/bws --color no"
BW_PREFIX="fluent_bundle"
...
case "${1:-}" in
    ...
    rm)     cmd_rm "$2" ;;
    *)
        echo "fluent_bundle secrets manager"
        echo ""
        echo "Usage:"
